...
from libc.stdint cimport (int8_t, int32_t, int64_t, uint8_t, uint16_t,
                          uint32_t, uintptr_t)
...
cdef extern from "c/pgenlib_ffi_support.h" namespace "plink2":
...
cdef extern from "c/include/pgenlib_read.h" namespace "plink2":
...
cdef extern from "c/include/pgenlib_write.h" namespace "plink2":
